...
ARCHLDSCRIPT	:= -T"D:/Intel/FPGA_lite/18.0/University_Program/Monitor_Program/build/altera-socfpga-hosted-with-vectors.ld"
ASFLAGS		:= $(ARCHASFLAGS)
...
# Files
HDRS		:=
SRCS		:= main.c draw.c interval_timer_ISR.c pushbutton_ISR.c exceptions.c logic.c data.c scene.c animation.c
